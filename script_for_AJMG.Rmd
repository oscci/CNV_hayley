...
p1 <- ggplot(cnvpheno,aes(y=log(total_Kbp),x=jitter_cnv,colour=trisomy,shape=bias_fac))+
 ...
 labs(x = "N CNVs",y="Total CNV span (log Kb)")+
  ...
  theme(legend.position=c(1,1.25),plot.margin=unit(c(1,1,1,1),"points"),legend.title = element_blank(),legend.text = element_text(size = 5),axis.title = element_text(size = 10),legend.box = "horizontal",
